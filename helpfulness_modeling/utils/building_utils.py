...
try:
    from helpfulness_modeling.models import models
...
def build_model(only_toker=False, checkpoint=None, args=None, **kwargs):
    config_file = "/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/preference_model.json"
    ...
    if 'model_name' not in config or 'pretrained_model_path' not in config:
        raise ValueError
    toker = AutoTokenizer.from_pretrained("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/pretrained_path")
    ...
    model = Model.from_pretrained("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/pretrained_path", args)
