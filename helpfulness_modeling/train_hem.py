...
from helpfulness_modeling.inputters import inputters
from helpfulness_modeling.utils.building_utils import build_model, deploy_model
from helpfulness_modeling.utils.distributed import all_reduce_and_rescale_tensors, all_gather_list
from helpfulness_modeling.utils.eval_utils import eval_model
import warnings
...
if __name__ == "__main__":
    ...
    if args.local_rank == -1 or get_rank() == 0:
        ...
        with open(join(output_dir, 'custom_config.json'), 'w', encoding='utf-8') as f:
            with open(f'helpfulnesss_model.json', 'r', encoding='utf-8') as ff:
