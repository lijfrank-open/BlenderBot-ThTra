...
def process_raw(num_fold=10):
    csv_file = "/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc/MI Dataset.csv"
    ...
    json.dump(fold_index, open("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc/dev_index.json", "w"))

    writter = open("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc/mi_data.txt", "w")
    ...
    writter.close()
    json.dump(labels, open("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc/mi_labels.json", "w"))
...
# with open("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc/mi_labels.json", "r") as f:
#     labels = json.load(f)
#     labels = list(labels.keys())

toker = build_model(only_toker=True)

SAVE_DIR = '/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc'
...
with open("/home/countrycelebration/code/Aligned-dPM-master/Aligned-dPM-master/preference_modeling/dataset/esc/esc_data.txt", "r") as f:
    reader = f.readlines()
