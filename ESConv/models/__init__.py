...
from models.strat_blenderbot_small import Model_situation as strat_blenderbot_small_situation
...
models = {
    ...
    'strat_blenderbot_small_situation': strat_blenderbot_small_situation,
