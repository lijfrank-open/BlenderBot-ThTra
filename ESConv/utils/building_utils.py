...
def build_model_situation(only_toker=False, checkpoint=None, local_rank=-1, **kwargs):
    ...
    toker = AutoTokenizer.from_pretrained("/home/countrycelebration/code/Aligned-dPM-original/ESConv/blenderbot_small-90M")
    ...
    Model = models['strat_blenderbot_small_situation']
    model = Model.from_pretrained("/home/lgqn/code/Aligned-dPM-original/ESConv/blenderbot_small-90M")
